...
<body>
    ...
    <div style="text-align: center;">
      ...
      <hr />
        <h2>Insert Tuple into Weapon</h2>
        <form method="POST" action="weapon.php"> <!--refresh page when submitted-->
            ...
            WEId: <input type="text" name="insWEId"> <br /><br />
            Level: <input type="text" name="insLevel"> <br /><br />
            WEAttack: <input type="text" name="insWEAttack"> <br /><br />
            Defence: <input type="text" name="insDefence"> <br /><br />
            ARId: <input type="text" name="insARId"> <br /><br />
...
<div style="text-align: center;">
    ...
    <h2>Select/List/Display tuples from Weapon</h2>
...
<div style="text-align: center;">
    ...
    <h2>Maximum Attack Weapon</h2>
        <form method="GET" action="weapon.php"> <!--refresh page when submitted-->
            <input type="hidden" id="displayMaxRequest" name="displayMaxRequest">
            
            <input type="submit" name="displayMaxTuples"></p>
        </form>
...
<div style="text-align: center;">
    ...
    <h2>Increase weapon attack by 1</h2>
        <form method="POST" action="weapon.php"> <!--refresh page when submitted-->
            <input type="hidden" id="increaseRequest" name="increaseRequest">
            Weapon Name: <input type="text" name="weaponname"> <br /><br />
            <input type="submit" name="increaseRequest"></p>
        </form>
...
<?php
		...
		if (isset($_POST['insertArmyRequest']) || isset($_POST['increaseRequest'])) {
            handlePOSTRequest();
        } else if (isset($_GET['countTupleRequest']) || isset($_GET['displayArmyRequest']) || isset($_GET['displayMaxRequest'])) {
            handleGETRequest();
        }

    function handleMaxArmyList() {
      global $db_conn;
            $result2 = executePlainSQL("SELECT  WEId FROM  WEAPON WHERE  WEAttack = (SELECT MAX(WEAttack) FROM WEAPON)");
            if (($row = oci_fetch_row($result2)) != false) {
                echo "<br> Retrieved the id of maximum attack weapon: " . $row[0] . "<br>";
            }
    }
		...
		function handleDisplayArmyList() {
            ...
            global $db_conn;
            $result1 = executePlainSQL("SELECT COUNT(*) FROM WEAPON");

            if (($row = oci_fetch_row($result1)) != false) {
                echo "<br> The number of tuples in weapon: " . $row[0] . "<br>";
            }

            

            $result3 = executePlainSQL("SELECT * from WEAPON");
            echo "<br>Retrieved data from table weapon:<br>";
            echo "<table>";
            echo "<tr>
            <th>WEId</th>
            <th>Level</th>
            ...
            echo "</table>";
            while (($row = oci_fetch_row($result3)) != false) {
    ...
    function handleIncreaseAttack() {
      global $db_conn;

            $name = $_POST['weaponname'];

            // you need the wrap the old name and new name values with single quotations
            executePlainSQL("UPDATE Weapon
        ...
        function handlePOSTRequest() {
            if (connectToDB()) {
                ...
                } else if (array_key_exists('increaseRequest', $_POST)) {
...
//                    handleDisRequest();
                } else if (array_key_exists('displayMaxRequest', $_GET)) {
                    handleMaxArmyList();
                }
