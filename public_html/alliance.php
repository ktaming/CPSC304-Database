...
<body>
    ...
    <div style="text-align: center;">
      ...
      <hr />
        <h2>Insert Tuple into Alliance</h2>
        <form method="POST" action="alliance.php"> <!--refresh page when submitted-->
            <input type="hidden" id="insertArmyRequest" name="insertArmyRequest">
            ALName: <input type="text" name="insALName"> <br /><br />
            ALCapacity: <input type="text" name="insALCapacity"> <br /><br />
...
<div style="text-align: center;">
    ...
    <h2>Select/List/Display tuples from Alliance</h2>
        <form method="GET" action="alliance.php"> <!--refresh page when submitted-->
...
<?php
    ...
    function handleDisplayArmyList() {
            global $db_conn;
            $result1 = executePlainSQL("SELECT COUNT(*) FROM ALLIANCE");

            if (($row = oci_fetch_row($result1)) != false) {
                echo "<br> The number of tuples in alliance: " . $row[0] . "<br>";
            }
        
            $result2 = executePlainSQL("SELECT * from ALLIANCE");
    ...
    //   global $db_conn;
    //   executePlainSQL("DROP TABLE ALLIANCE");
    //         echo "<br> Dropped old alliance table <br>";
    // }
    ...
    function handleInsertArmyRequest() {
            ...
            executeBoundSQL("insert into ALLIANCE values (:bind1, :bind2)", $alltuples);
            OCICommit($db_conn);
        }
