...
<body>
    ...
    <div style="text-align: center;">
      ...
      <hr />
        <h2>Insert Tuple into Army</h2>
        <form method="POST" action="army.php"> <!--refresh page when submitted-->
            <input type="hidden" id="insertArmyRequest" name="insertArmyRequest">
            ARName: <input type="text" name="insARName"> <br /><br />
            AMCapacity: <input type="text" name="insAMCapacity"> <br /><br />
            SoldierType: <input type="text" name="insSoldierType"> <br /><br />
            Expenditure: <input type="text" name="insExpenditure"> <br /><br />
...
<div style="text-align: center;">
    ...
    <h2>Select/List/Display tuples from Army</h2>
        <form method="GET" action="army.php"> <!--refresh page when submitted-->
...
<?php
		...
		function handleDisplayArmyList() {
            global $db_conn;
            $result = executePlainSQL("SELECT COUNT(*) FROM ARMY");

            if (($row = oci_fetch_row($result)) != false) {
                echo "<br> The number of tuples in role: " . $row[0] . "<br>";
            }
        
            $result2 = executePlainSQL("SELECT * from army");
			echo "<br>Retrieved data from table army:<br>";
            echo "<table>";
            echo "<tr>
            <th>ARName</th>
            <th>AMCapacity</th>
		...
		// 	global $db_conn;
		// 	executePlainSQL("DROP TABLE ARMY");
  //           echo "<br> Dropped old army table <br>";
		// }
		
		// function tempCreateArmy() {
		// 	global $db_conn;
		// 	executePlainSQL("CREATE TABLE ARMY (
		// 		ARName      CHAR(20),
		// 		AMCapacity  int,
		// 	    SoldierType CHAR(20),
		// 	    Expenditure int,
  ...
  //           echo "<br> Created a new army table <br>";
		// }
		...
		function handleInsertArmyRequest() {
            ...
            $tuple = array (
                ...
                ":bind2" => $_POST['insAMCapacity'],
                ":bind3" => $_POST['insSoldierType'],
                ":bind4" => $_POST['insExpenditure'],
                ":bind5" => $_POST['insNAName'],
                ":bind6" => $_POST['insROName']
            );
            ...
            executeBoundSQL("insert into ARMY values (:bind1, :bind2, :bind3, :bind4, :bind5, :bind6)", $alltuples);
            OCICommit($db_conn);
        }
