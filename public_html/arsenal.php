...
<body>
    ...
    <div style="text-align: center;">
      ...
      <hr />
        <h2>Insert Tuple into Arsenal</h2>
        <form method="POST" action="arsenal.php"> <!--refresh page when submitted-->
            ...
            ASCapacity: <input type="text" name="insASCapacity"> <br /><br />
...
<div style="text-align: center;">
    ...
    <h2>Select/List/Display tuples from Arsenal</h2>
        <form method="GET" action="arsenal.php"> <!--refresh page when submitted-->
...
<?php
		...
		function handleDisplayArmyList() {
            global $db_conn;
            $result1 = executePlainSQL("SELECT COUNT(*) FROM ARSENAL");

            if (($row = oci_fetch_row($result1)) != false) {
                echo "<br> The number of tuples in arsenal: " . $row[0] . "<br>";
            }
        
            $result2 = executePlainSQL("SELECT * from ARSENAL");
            echo "<br>Retrieved data from table arsenal:<br>";
            echo "<table>";
            echo "<tr>
            <th>ARId</th>
            <th>Location</th>
  ...
  //   }
		...
		function handleInsertArmyRequest() {
            ...
            executeBoundSQL("insert into FAMILY values (:bind1, :bind2, :bind3,:bind4)", $alltuples);
            OCICommit($db_conn);
        }
